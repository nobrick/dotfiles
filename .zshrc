...
export PATH="~/npm-global/bin:$HOME/.rbenv/bin:/Library/Frameworks/Python.framework/Versions/3.3/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/usr/local/git/bin:/usr/texbin"
...
ben_async_restart() { cap staging unicorn:restart & rsync -rvC ${1} ben:kano/current/${1}; }
