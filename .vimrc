...
"noremap <Leader><Leader>c :cs find 
"noremap <Leader><Leader>s :cs find s 
"noremap <Leader><Leader>g :cs find g 
"noremap <Leader><Leader>a :cs add cscope.out<CR>
...
noremap <C-t><C-s> :tab split<CR>
noremap <C-t>s :tab split<CR>
...
if has("gui_macvim")
    ...
    "let g:EasyMotion_mapping_F = '<M-d>'
    "imap <M-f> <ESC><M-f>
    "imap <M-d> <ESC><M-d>
